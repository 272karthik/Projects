...
// const karthik = "I'm " + firstName + ', a ' + (year - birthYear) + ' year old ' + job + '!';
// console.log(karthik);

// const karthikNew = `I'm ${firstName}, a ${year - birthYear} year old ${job}!`;
...
// const me = 'Karthik';
// console.log(`I'm ${2026 - 2003} years old ${me}`);
